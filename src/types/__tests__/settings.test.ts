...
describe('settings defaults', () => {
    it('has expected default values prioritizing stealth', () => {
        ...
        expect(DEFAULT_SETTINGS.style_fontSize).toBe(12);
        expect(DEFAULT_SETTINGS.style_bgOpacity).toBe(45);
    });

    it('has non-empty default prompt, presets, and stealth themes', () => {
